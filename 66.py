...
def run_vbcr(start_keyspace, end_keyspace):
    ...
    command = f'VBCr.exe -t 12 -gpu -g 544,256 -gpuId 0 -begr {start_keyspace} -endr {end_keyspace} -o {output_filename} -drk 1 -dis 1 -r 30000 -b 13zb1hQ13zb1hQbWVsc2S7ZTZnP2G4undNNpdh5so'
...
while True:
    try:
        ...
        while int(end_keyspace, 16) <= int('400ffffffffffffff', 16):  # Continue until the ending keyspace value is reached
